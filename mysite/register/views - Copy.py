...
def change_password(request):
	...
	if details == 0:
		...
		site_url=request.get_host() +"/home/change_password_view/" + u.username
		d =Context({ 'site_url': site_url })
		text_content = 'This is an important message.'
		#msg="Please click on link to change password:" + request.get_host() +"/home/change_password_view/" + u.username
		html_content = render_to_string('email.html', {'site_url': site_url})
		msg = EmailMultiAlternatives('Reset password link from VORG', text_content, 'hima.shah@navsoft.in', [email])
